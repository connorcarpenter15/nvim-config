...
-- --------------------------------- VIMTEX --------------------------------------------
vim.keymap.set("n", "<leader>vl", ":VimtexCompile<CR>", { silent = true, desc = "Vimtex Compile" })
vim.keymap.set("n", "<leader>vL", ":VimtexCompileSS<CR>", { silent = true, desc = "Vimtex Compile SS" })
vim.keymap.set("n", "<leader>vr", ":VimtexView<CR>", { silent = true, desc = "Vimtex View" })
vim.keymap.set("n", "<leader>vc", ":VimtexClean<CR>", { silent = true, desc = "Vimtex Clean" })
vim.keymap.set("n", "<leader>vC", ":VimtexCleanF<CR>", { silent = true, desc = "Vimtex Clean Force" })
vim.keymap.set("n", "<leader>vo", ":VimtexCompileOutput<CR>", { silent = true, desc = "Vimtex Compile Output" })
vim.keymap.set("n", "<leader>vk", ":VimtexStop<CR>", { silent = true, desc = "Vimtex Stop" })
vim.keymap.set("n", "<leader>vK", ":VimtexStopAll<CR>", { silent = true, desc = "Vimtex Stop All" })
vim.keymap.set("n", "<leader>vt", ":VimtexTocOpen<CR>", { silent = true, desc = "Vimtex TOC Open" })
vim.keymap.set("n", "<leader>vT", ":VimtexTocToggle<CR>", { silent = true, desc = "Vimtex TOC Toggle" })
vim.keymap.set("n", "<leader>vi", ":VimtexInfo<CR>", { silent = true, desc = "Vimtex Info" })
vim.keymap.set("n", "<leader>vI", ":VimtexInfoF<CR>", { silent = true, desc = "Vimtex Info Force" })
vim.keymap.set("n", "<leader>vx", ":VimtexReload<CR>", { silent = true, desc = "Vimtex Reload" })
vim.keymap.set("n", "<leader>vX", ":VimtexReloadState<CR>", { silent = true, desc = "Vimtex Reload State" })
vim.keymap.set("n", "<leader>vv", ":VimtexView<CR>", { silent = true, desc = "Vimtex View" })
vim.keymap.set("n", "<leader>ve", ":VimtexErrors<CR>", { silent = true, desc = "Vimtex Errors" })
vim.keymap.set("n", "<leader>va", ":VimtexContextMenu<CR>", { silent = true, desc = "Vimtex Context Menu" })
vim.keymap.set("n", "<leader>vg", ":VimtexStatus<CR>", { silent = true, desc = "Vimtex Status" })
vim.keymap.set("n", "<leader>vq", ":VimtexLog<CR>", { silent = true, desc = "Vimtex Log" })
vim.keymap.set("n", "<leader>vs", ":VimtexToggleMain<CR>", { silent = true, desc = "Vimtex Toggle Main" })
vim.keymap.set("n", "<leader>vm", ":VimtexImapsList<CR>", { silent = true, desc = "Vimtex Imaps List" })
